...
class ServicesController extends Controller
{
    ...
    public function create() 
    {
        ...
        return view('pages.services.create',[
            ...
            'productTypes' => Type::where('id','=','2')->orWhere('id','=','8')->latest()->get(),
            'productTypesRemark' => Type::where('id','=','2')->orWhere('id','=','8')->latest()->get()->pluck('remark')->toArray(),
    ...
    public function store(Product $product,Request $request) 
    {
        ...
        DB::select('insert into voucher_detail select distinct voucher_code,ps.id,now(),1,now() from voucher v  join product_sku ps on ps.id='.$my_id.' and ps.type_id = 2 where v.is_allitem=1;');
    ...
    public function show(Product $product) 
    {
        ...
        ->get(['pu.uom_id','uo.remark as product_uom','product_sku.photo','product_sku.id as product_id','product_sku.abbr','product_sku.remark as product_name','pt.remark as product_type','pc.remark as product_category','pb.remark as product_brand'])->first();
