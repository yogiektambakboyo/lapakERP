...
class ServicesController extends Controller
{
    ...
    public function index(Request $request) 
    {
        ...
        $products = Product::orderBy('product_sku.remark', 'ASC')
                    ...
                    ->where('pt.id','=','2')
                    ->paginate(10,['product_sku.photo','product_sku.id','product_sku.remark as product_name','pt.abbr as product_type','pc.remark as product_category','pb.remark as product_brand']);
    ...
    public function show(Product $product) 
    {
        ...
        ->get(['product_sku.photo','product_sku.id as product_id','product_sku.abbr','product_sku.remark as product_name','pt.abbr as product_type','pc.remark as product_category','pb.remark as product_brand'])->first();
