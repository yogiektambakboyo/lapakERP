...
class InvoicesController extends Controller
{
    ...
    public function edit(Invoice $invoice) 
    {
        ...
        $isvalid_edit = DB::select(" select close_trans,remark from period where where '".$invoice->dated."'::date between start_cal and end_cal and period_no=to_char('".$invoice->dated."'::date,'YYYYMM')::int; ");
