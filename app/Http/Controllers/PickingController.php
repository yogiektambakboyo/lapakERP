...
class PickingController extends Controller
{
    ...
    public function printsj(Invoice $invoice) 
    {
        ...
        $pdf = PDF::setOptions(['isHtml5ParserEnabled' => true, 'isRemoteEnabled' => true])->loadView('pages.picking.printsj', [
            'data' => $data,
            'settings' => Settings::get(),
            'invoice' => Invoice::join('users as u','u.id','=','invoice_master.created_by')->where('invoice_master.id',$invoice->id)->get(['invoice_master.*','u.name'])->first(),
    ...
    public function printspk(Invoice $invoice) 
    {
        ...
        $pdf = PDF::setOptions(['isHtml5ParserEnabled' => true, 'isRemoteEnabled' => true])->loadView('pages.picking.printspk', [
            'data' => $data,
