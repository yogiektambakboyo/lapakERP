...
class UsersController extends Controller
{
    ...
    public function show(User $user) 
    {
        ...
        $users = DB::select("select u.employee_status,u.id,u.employee_id,u.name,string_agg(b.remark,',') as branch_name,u.join_date,u.phone_no,u.email,u.username,u.address,u.netizen_id,u.photo_netizen_id,u.photo,u.join_years,u.active,u.referral_id,u.city,u.gender,u.birth_place,u.birth_date 
                             from users u 
