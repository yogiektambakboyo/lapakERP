...
class ProductsDistributionController extends Controller
{
    /**
    ...
    private $data,$act_permission,$module="productsdistribution",$id=1;
    ...
    public function index(Request $request) 
    {
        ...
        return view('pages.productsdistribution.index', compact('products','data','keyword','act_permission'))->with('i', ($request->input('page', 1) - 1) * 5);
    }
    ...
    public function show(Product $product) 
    {
        ...
        return view('pages.productsdistribution.show', [
            'product' => $products ,
            'data' => $data,
        ]);
    }
    ...
    public function edit(String $branch_id,String $product_id) 
    {
        ...
        return view('pages.productsdistribution.edit', [
            'branchs' => Branch::join('users_branch as ub','ub.branch_id','=','branch.id')->where('ub.user_id','=',$user->id)->get(['branch.id','branch.remark']),
            'data' => $data,
            'active' => $active,
            'product' => $product,
