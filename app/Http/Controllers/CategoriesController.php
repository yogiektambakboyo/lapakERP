...
class CategoriesController extends Controller
{
    ...
    {   
        ...
        $categories = Category::where('type_id','=','1')->orderBy('remark')->get(['product_category.id','product_category.remark','product_category.add_column_2','product_category.add_colum']);
        $data = $this->data;
