...
class OtherController extends Controller
{
    ...
    public function notif() 
    {
        ...
        $notify = DB::select("
                select id,user_id,message,isread,created_at,notif_type  from inbox_user iu where iu.isread = 0 and iu.user_id = ".Auth::id()." order by iu.created_at desc limit 99; 
        ");
        return $notify;
    }
