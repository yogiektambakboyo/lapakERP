...
class PresenceAnalysisController extends Controller
{
    ...
    public function index(Request $request) 
    {
        ...
        order by wt.id");
        return view('pages.worktime.indexanalysis',['company' => Company::get()->first()], compact('worktime','data','keyword','act_permission','branchs','payment_type'))->with('i', ($request->input('page', 1) - 1) * 5);
    }
