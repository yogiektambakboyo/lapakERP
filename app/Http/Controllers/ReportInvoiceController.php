...
class ReportInvoiceController extends Controller
{
    ...
    private $data,$act_permission,$module="reports.invoice",$id=1;
    ...
    public function index(Request $request) 
    {
        ...
        $report_data = DB::select("
                select b.remark as branch_name,im.dated,s.remark as shift_name,im.invoice_no,im.customers_name,im.total,im.total_payment,im.payment_type,coalesce(im.ref_no,'-') ref_no,u.name as created_by_name,im.created_at
        ...
        return view('pages.reports.invoice',['company' => Company::get()->first()], compact('shifts','branchs','data','keyword','act_permission','report_data'))->with('i', ($request->input('page', 1) - 1) * 5);
    }
