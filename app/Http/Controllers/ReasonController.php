...
class ReasonController extends Controller
{
    ...
    private $data,$act_permission,$module="reason",$id=1;
    ...
    public function index(Request $request) 
    {
        ...
        $doc_data = DB::select("select id,reason_type,remark
        from reason v order by remark ");
        return view('pages.reason.index',['company' => Company::get()->first()] ,compact('request','branchs','doc_data','data','keyword','act_permission'));
    }
    ...
    public function store(Request $request) 
    {
        ...
        return redirect()->route('reason.index')
            ->withSuccess(__('Berhasil membuat alasan baru.'));
    }
