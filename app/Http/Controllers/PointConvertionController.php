...
use App\Models\PointConvertion;
...
class PointConvertionController extends Controller
{
    /**
    ...
    private $data,$act_permission,$module="pointconvertion",$id=1;
    ...
    public function search(Request $request) 
    {
        ...
        if($request->export=='Export Excel'){
            ...
            $products = Product::orderBy('product_sku.remark', 'ASC')
                        ...
                        ->where('pt.id','=','1')
                        ->get(['product_sku.id','product_sku.remark as product_name','pr.branch_id','bc.remark as branch_name','pr.point as point','pb.remark as product_brand']);           
            return view('pages.pointconvertion.index',['company' => Company::get()->first()], compact('products','data','keyword','act_permission'))->with('i', ($request->input('page', 1) - 1) * 5);
        }
    }
    ...
    public function create() 
    {
        ...
        $user  = Auth::user();
        $data = $this->data;
        return view('pages.pointconvertion.create',[
    ...
    public function show(Product $product) 
    {
        ...
        return view('pages.pointconvertion.show', [
            'product' => $products ,
            'data' => $data, 'company' => Company::get()->first(),
        ]);
    }
