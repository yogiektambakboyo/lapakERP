...
class ProductsDistributionExport implements FromCollection,WithColumnFormatting, WithHeadings
{
    /**
    ...
    */
    ...
    public function collection()
    {
        ...
        Product::orderBy('product_sku.remark', 'ASC')
                        ...
                        ->get(['product_sku.external_code','product_sku.remark as product_name','bc.remark as branch_name','pr.active as active']);            
