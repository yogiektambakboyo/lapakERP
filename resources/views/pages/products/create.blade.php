  ...
  @csrf
    <div class="bg-light p-4 rounded">
        ...
        <div class="panel text-white">
          ...
          <div class="row mb-3">
            <label class="form-label col-form-label col-md-2">@lang('general.lbl_product_desc')</label>
            <div class="col-md-8">
              <input type="text" class="form-control" name="product_desc" value="{{ old('product_desc') }}"  />
            </div>
          </div>
          <div class="row mb-3">
            <label class="form-label col-form-label col-md-2">@lang('general.lbl_external_code')</label>
            <div class="col-md-8">
              <input type="text" class="form-control" name="external_code" value="{{ old('external_code') }}"  />
            </div>
          </div>
          <div class="row mb-3">
