...
@section('content')
    <div class="bg-light p-4 rounded">
        <h1>@lang('general.lbl_price_adjustment')</h1>
        <div class="lead row mb-3">
            <div class="col-md-10">
                ...
                <div class="col-md-10"> 	
                    <form action="{{ route('servicespriceadj.search') }}" method="GET" class="row row-cols-lg-auto g-3 align-items-center">
            ...
            <div class="col-md-2">
                <a href="{{ route('servicespriceadj.create') }}" class="btn btn-primary float-right  {{ $act_permission->allow_create==1?'':'d-none' }}"><span class="fa fa-plus-circle"></span>  @lang('general.btn_create')</a>
            </div>
        </div>
        ...
        <div class="modal fade" id="modal-filter" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('servicespriceadj.search') }}" method="GET">   
                        @csrf 
                        <div class="col-md-10">
...
$(document).ready(function () {
        ...
        function showConfirm(branch_id,product_id,dated_start,dated_end,data){
            ...
            if (result.isConfirmed) {
                var url = "{{ route('servicespriceadj.destroy',['AA','BB','CC','DD']) }}";
                var lastvalurl = "AA";
                var lastvalurl2 = "BB";
                var lastvalurl3 = "CC";
                var lastvalurl4 = "DD";
                        ...
                        if(resp.data.status=="success"){
                            Swal.fire({
                                ...
                                confirmButtonText: "@lang('general.lbl_close') "
                                    ...
                                    window.location.href = "{{ route('servicespriceadj.index') }}"; 
                                })
                        }else{
                            Swal.fire(
                            {
