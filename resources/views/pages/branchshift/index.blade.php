...
@section('content')
    <div class="bg-light p-4 rounded">
        <h2>@lang('general.lbl_shift_branch')</h2>
        ...
        <div class="lead row mb-3">
            ...
            <div class="col-md-2">
                <a href="{{ route('branchshift.create') }}" class="btn btn-primary btn-sm float-right"><span class="fa fa-plus-circle"></span>   @lang('general.btn_create')</a>
            </div>
        </div>
        <div class="mt-2">
        ...
        <div class="modal fade" id="modal-filter" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('branchshift.search') }}" method="GET">   
                        @csrf 
                        <div class="col-md-10">
          ...
          function showConfirm(id,data,dated){
            ...
            confirmButtonText: "@lang('general.lbl_sure_delete')"
                ...
                if (result.isConfirmed) {
                    var url = "{{ route('branchshift.destroy','XX') }}";
                    var lastvalurl = "XX";
                                ...
                                if(resp.data.status=="success"){
                                    Swal.fire({
                                        ...
                                        confirmButtonText: "@lang('general.lbl_close') "
                                            ...
                                            window.location.href = "{{ route('branchshift.index') }}"; 
                                        })
                                }else{
                                    Swal.fire(
                                    {
