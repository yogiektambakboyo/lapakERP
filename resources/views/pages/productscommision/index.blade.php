...
@section('content')
    <div class="bg-light p-4 rounded">
        <h1>Products Commision</h1>
        <div class="lead row mb-3">
            <div class="col-md-10">
                <div class="col-md-4">
                    Manage your products commision here.
                </div>
                <div class="col-md-10"> 	
            ...
            <div class="col-md-2">
                <a href="{{ route('productscommision.create') }}" class="btn btn-primary float-right  {{ $act_permission->allow_create==1?'':'d-none' }}"><span class="fa fa-plus-circle"></span>  Add new product commision</a>
            </div>
        </div>
        ...
        <table class="table table-striped" id="example">
            ...
            <tr>
                ...
                <th scope="col" width="10%">Creator Fee</th>
                <th scope="col" width="10%">Executor Fee</th>
                <th scope="col" width="10%">Referral Fee</th>
            ...
            <tbody>
                ...
                @foreach($products as $product)
                    <tr>
                        ...
                        <td><a href="{{ route('productscommision.edit', [$product->branch_id,$product->id]) }}" class="btn btn-info btn-sm  {{ $act_permission->allow_edit==1?'':'d-none' }}">Edit</a></td>
