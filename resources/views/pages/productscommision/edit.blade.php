...
@section('content')
<form method="POST" action="{{ route('productscommision.update', [$product->branch_id,$product->id]) }}"  enctype="multipart/form-data">
  @method('patch')
  @csrf
    <div class="bg-light p-4 rounded">
        ...
        <div class="panel text-white">
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-8">
              <input type="text" class="form-control" name="assigned_to_fee"  value="{{ $product->assigned_to_fee }}"/>
            </div>
          </div>
          </div>
        </div>
