...
@section('content')
	...
	<div class="row container">
		<div class="mt-5">
			<h2>Kebijakan & Privasi Aplikasi Seluler Bali Foam American Agent - American Pillo</h2>
		</div>
		<div>
		...
		<br>
		<div>
			Dengan menghapus akun, Anda tidak akan bisa mendapatkan kembali akses aplikasi dan data Anda. Semua data akun Bali Foam American Pillo Anda akan dihapus
		</div>
		<div>
