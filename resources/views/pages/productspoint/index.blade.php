...
@section('content')
    <div class="bg-light p-4 rounded">
        ...
        <div class="lead row mb-3">
            ...
            <div class="col-md-2">
                <a href="{{ route('productspoint.create') }}" class="btn btn-primary float-right  {{ $act_permission->allow_create==1?'':'d-none' }}"><span class="fa fa-plus-circle"></span>  @lang('general.btn_create')</a>
            </div>
        </div>
            ...
            <tbody>
                ...
                @foreach($products as $product)
                    <tr>
                        ...
                        <td>{{ $product->point }}</td>
                        <td><a href="{{ route('productspoint.edit', [$product->branch_id,$product->id]) }}" class="btn btn-info btn-sm  {{ $act_permission->allow_edit==1?'':'d-none' }}">@lang('general.lbl_edit')</a></td>
