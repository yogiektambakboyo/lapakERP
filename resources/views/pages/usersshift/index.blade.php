            ...
            <div class="col-md-10">
                ...
                <div class="col-md-10"> 	
                    <form action="{{ route('usersshift.search') }}" method="GET" class="row row-cols-lg-auto g-3 align-items-center">
                        <div class="col-2"><input type="hidden" class="form-control  form-control-sm" name="search" placeholder="@lang('general.lbl_search') User Shift.." value="{{ $request->search }}"></div>
