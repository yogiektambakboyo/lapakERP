...
@section('content')
    <div class="bg-light p-4 rounded">
        ...
        <div class="lead row mb-3">
            <div class="col-md-10">
                <div class="col-md-12">
                    Manage your orders here, default data display last 7 days ago. Please use filter for show more data.
                </div>
                <div class="col-md-10"> 	
            ...
            <div class="col-md-2">
                <a href="{{ route('invoices.create') }}" class="btn btn-primary float-right {{ $act_permission->allow_create==1?'':'d-none' }}"><span class="fa fa-plus-circle"></span>  Add new invoice</a>
            </div>
        </div>
                ...
                @foreach($invoices as $order)
                    <tr>
                        ...
                        <td class=" {{ $act_permission->allow_delete==1?'':'d-none' }}">
                            <a onclick="showConfirm({{ $order->id }}, '{{ $order->order_no }}')" class="btn btn-danger btn-sm  {{ $act_permission->allow_delete==1?'':'d-none' }} ">Delete</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
