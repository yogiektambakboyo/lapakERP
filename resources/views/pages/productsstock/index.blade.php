...
@section('content')
    <div class="bg-light p-4 rounded">
        ...
        <div class="lead row mb-3">
            ...
            <div class="col-md-2">
                <a href="{{ route('productsstock.create') }}" class="btn btn-primary float-right  {{ $act_permission->allow_create==1?'':'d-none' }}"> <span class="fa fa-plus-circle"></span>  Add product stock</a>
            </div>
        </div>
