...
@section('content')
    <div class="bg-light p-4 rounded">
        <div class="row">
          ...
          <div class="col-md-2">
            <div class="mt-4">
                <a href="{{ route('productsstock.edit', $product->product_id) }}" class="btn btn-info">Edit</a>
                <a href="{{ route('productsstock.index') }}" class="btn btn-default">@lang('general.lbl_back') </a>
            </div>
          </div>
        </div>
