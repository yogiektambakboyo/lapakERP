...
@section('content')
    <div class="bg-light p-4 rounded">
        ...
        <div class="lead row mb-3">
            <div class="col-md-10">
                <div class="col-md-4">
                    Manage your products distribution here.
                </div>
                <div class="col-md-10"> 	
            ...
            <div class="col-md-2">
                <a href="{{ route('productsdistribution.create') }}" class="btn btn-primary float-right  {{ $act_permission->allow_create==1?'':'d-none' }}"><span class="fa fa-plus-circle"></span>  Add new product price</a>
            </div>
        </div>
            ...
            <tbody>
                ...
                @foreach($products as $product)
                    <tr>
                        ...
                        <td><a href="{{ route('productsdistribution.edit', [$product->branch_id,$product->id]) }}" class="btn btn-info btn-sm  {{ $act_permission->allow_edit==1?'':'d-none' }}">Edit</a></td>
