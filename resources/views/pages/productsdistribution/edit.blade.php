...
@section('content')
<form method="POST" action="{{ route('productsdistribution.update', [$product->branch_id,$product->id]) }}"  enctype="multipart/form-data">
  @method('patch')
  @csrf
        ...
        <div class="row">
          ...
          <div class="col-md-2">
            <div class="mt-4">
              ...
              <a href="{{ route('productsdistribution.index') }}" class="btn btn-default">Cancel</a>
            </div>
          </div>
        </div>
