    ...
    <div class="bg-light p-4 rounded">
        ...
        <div class="lead row mb-3">
            <div class="col-md-10">
                ...
                <div class="col-md-10"> 	
                    <form action="{{ route('rewards.search') }}" method="GET" class="row row-cols-lg-auto g-3 align-items-center">
            ...
            <div class="col-md-2">
                <a href="{{ route('rewards.create') }}" class="btn btn-primary float-right  {{ $act_permission->allow_create==1?'':'d-none' }}"><span class="fa fa-plus-circle"></span>  @lang('general.btn_create')</a>
            </div>
        </div>
        ...
        <table class="table table-striped" id="example">
            ...
            <tr>
                ...
                <th scope="col" width="7%">Poin</th>
                <th scope="col" width="7%">Kuota</th>
                <th scope="col" width="10%">Sisa Kuota</th>
            ...
            <tbody>
                ...
                @foreach($products as $product)
                    <tr>
                        ...
                        <td>{{ number_format($product->point,0,',','.') }}</td>
                        <td>{{ number_format($product->quota,0,',','.') }}</td>
                        <td>{{ number_format($product->quota_available,0,',','.') }}</td>
                        <td><a href="{{ route('rewards.edit', $product->id) }}" class="noexport btn btn-info btn-sm  {{ $act_permission->allow_edit==1?'':'d-none' }}">@lang('general.lbl_edit')</a></td>
        ...
        <div class="modal fade" id="modal-filter" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('rewards.search') }}" method="GET">   
                        @csrf 
                        <div class="col-md-10">
...
@push('scripts')
    <script type="text/javascript">
        ...
        function showConfirm(branch_id,data){
            Swal.fire({
            ...
            if (result.isConfirmed) {
                var url = "{{ route('rewards.destroy',['AA','BB','CC','DD','EE']) }}";
                var lastvalurl = "AA";
                var lastvalurl2 = "BB";
                var lastvalurl3 = "CC";
                var lastvalurl4 = "DD";
