        ...
        <div class="lead">
          ...
          <div class="row">
            ...
            <div class="col-md-11">
                ...
                <label class="col-md-8"><h1 class="">{{ $user->name }}</h1></label>
            </div>
          </div>
        ...
        <div class="panel text-white">
          ...
          <div class="panel-body bg-white text-black">
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-8">
                <input readonly type="checkbox" disabled name="active" id="active" value="{{ $user->active }}" {{ $user->active==1 ? 'checked' : ''  }} > <label for="active">Active</label>
              </div>
            </div>
          </div>
        </div>
