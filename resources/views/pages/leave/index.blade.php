...
@section('title', 'Rekap Izin Tidak Masuk')

@section('content')
    <div class="bg-light p-4 rounded">
        <h1>Rekap Izin Tidak Masuk</h1>
        <div class="lead row mb-3">
            <div class="col-md-10">
                <div class="col-md-12">
                    Atur data izin anda disini, data yang tampil adalah 7 hari kebelakang. Silahkan gunakan Saring untuk data lebih lengkap
                </div>
                <div class="col-md-10"> 	
                    <form action="{{ route('leave.search') }}" method="GET" class="row row-cols-lg-auto g-3 align-items-center">
        ...
        <table class="table table-striped" id="example">
            ...
            <tr>
                ...
                <th>Nama</th>
                <th scope="col" width="15%">Tgl Awal</th>
                <th scope="col" width="10%">Tgl Akhir</th>
                <th scope="col" width="10%">Keperluan</th>
                <th scope="col" width="15%">Sudah Approve</th>
            ...
            <tbody>
                ...
                @foreach($worktime as $order)
                    <tr>
                        ...
                        <td>{{ $order->nama }}</td>
                        <td>{{ Carbon\Carbon::parse($order->dated_start)->format('d-m-Y') }}</td>
                        <td>{{ Carbon\Carbon::parse($order->dated_end)->format('d-m-Y') }}</td>
                        <td>{{ $order->reason }}</td>
                        <td>{{ $order->is_approve }}</td>
