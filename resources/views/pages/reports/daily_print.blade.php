            ...
            @foreach($dtt_detail as $detail)
                  <tr>
                      ...
                      @foreach($dtt_raw_oneline as $header)
                          ...
                          @if((int)$header->total_307>0)
                            @php if((int)$dtt_raw[$counter]->total_307>0 || (int)$dtt_raw_disc[$counter]->total_307>0){ $c_307=$c_307+$dtt_raw_qty[$counter]->total_307; } @endphp 
                          ...
                          @if((int)$header->total_308>0)
                            @php if((int)$dtt_raw[$counter]->total_308>0 || (int)$dtt_raw_disc[$counter]->total_308>0){ $c_308=$c_308+$dtt_raw_qty[$counter]->total_308; } @endphp 
                            <td scope="col" width="3%"> @php if((int)$dtt_raw[$counter]->total_308<=0 && (int)$dtt_raw_disc[$counter]->total_308>0){ echo 'Free'; }else{ echo number_format($dtt_raw[$counter]->total_308,0,',','.'); } @endphp </td>
                          @endif
                          @if((int)$header->total_310>0)
                            @php if((int)$dtt_raw[$counter]->total_310>0 || (int)$dtt_raw_disc[$counter]->total_310>0){ $c_310=$c_310+$dtt_raw_qty[$counter]->total_310; } @endphp 
                            <td scope="col" width="3%"> @php if((int)$dtt_raw[$counter]->total_310<=0 && (int)$dtt_raw_disc[$counter]->total_310>0){ echo 'Free'; }else{ echo number_format($dtt_raw[$counter]->total_310,0,',','.'); } @endphp </td>
                          @endif
                      
                          @if((int)$header->total_312>0)
                            @php if((int)$dtt_raw[$counter]->total_312>0 || (int)$dtt_raw_disc[$counter]->total_312>0){ $c_312=$c_312+$dtt_raw_qty[$counter]->total_312; } @endphp 
                            <td scope="col" width="3%"> @php if((int)$dtt_raw[$counter]->total_312<=0 && (int)$dtt_raw_disc[$counter]->total_312>0){ echo 'Free'; }else{ echo number_format($dtt_raw[$counter]->total_312,0,',','.'); } @endphp </td>
                          @endif
                        
                          @if((int)$header->total_313>0)
                            @php if((int)$dtt_raw[$counter]->total_313>0 || (int)$dtt_raw_disc[$counter]->total_313>0){ $c_313=$c_313+$dtt_raw_qty[$counter]->total_313; } @endphp 
                            <td scope="col" width="3%"> @php if((int)$dtt_raw[$counter]->total_313<=0 && (int)$dtt_raw_disc[$counter]->total_313>0){ echo 'Free'; }else{ echo number_format($dtt_raw[$counter]->total_313,0,',','.'); } @endphp </td>
                          @endif

                          @if((int)$header->total_315>0)
                            @php if((int)$dtt_raw[$counter]->total_315>0 || (int)$dtt_raw_disc[$counter]->total_315>0){ $c_315=$c_315+$dtt_raw_qty[$counter]->total_315; } @endphp 
                            <td scope="col" width="3%"> @php if((int)$dtt_raw[$counter]->total_315<=0 && (int)$dtt_raw_disc[$counter]->total_315>0){ echo 'Free'; }else{ echo number_format($dtt_raw[$counter]->total_315,0,',','.'); } @endphp </td>
                          @endif
                        
                          @if((int)$header->total_317>0)
                            @php if((int)$dtt_raw[$counter]->total_317>0 || (int)$dtt_raw_disc[$counter]->total_317>0){ $c_317=$c_317+$dtt_raw_qty[$counter]->total_317; } @endphp 
                            <td scope="col" width="3%"> @php if((int)$dtt_raw[$counter]->total_317<=0 && (int)$dtt_raw_disc[$counter]->total_317>0){ echo 'Free'; }else{ echo number_format($dtt_raw[$counter]->total_317,0,',','.'); } @endphp </td>
                          @endif

                          @if((int)$header->total_321>0)
                            @php if((int)$dtt_raw[$counter]->total_321>0 || (int)$dtt_raw_disc[$counter]->total_321>0){ $c_321=$c_321+$dtt_raw_qty[$counter]->total_321; } @endphp 
                            <td scope="col" width="3%"> @php if((int)$dtt_raw[$counter]->total_321<=0 && (int)$dtt_raw_disc[$counter]->total_321>0){ echo 'Free'; }else{ echo number_format($dtt_raw[$counter]->total_321,0,',','.'); } @endphp </td>
                          @endif
                         


                          @if((int)$header->total_468>0)
                            @php if((int)$dtt_raw[$counter]->total_468>0 || (int)$dtt_raw_disc[$counter]->total_468>0){ $c_468=$c_468+$dtt_raw_qty[$counter]->total_468; } @endphp 
                            <td scope="col" width="3%"> @php if((int)$dtt_raw[$counter]->total_468<=0 && (int)$dtt_raw_disc[$counter]->total_468>0){ echo 'Free'; }else{ echo number_format($dtt_raw[$counter]->total_468,0,',','.'); } @endphp </td>
                          @endif
                          @if((int)$header->total_469>0)
                          ...
                          @if((int)$header->total_498>0)
                            @php if((int)$dtt_raw[$counter]->total_498>0 || (int)$dtt_raw_disc[$counter]->total_498>0){ $c_498=$c_498+$dtt_raw_qty[$counter]->total_498; } @endphp 
                            <td scope="col" width="3%"> @php if((int)$dtt_raw[$counter]->total_498<=0 && (int)$dtt_raw_disc[$counter]->total_498>0){ echo 'Free'; }else{ echo number_format($dtt_raw[$counter]->total_498,0,',','.'); } @endphp </td>
                          @endif
                          @if((int)$header->total_316>0)
                             @php if((int)$dtt_raw[$counter]->total_316>0 || (int)$dtt_raw_disc[$counter]->total_316>0){ $c_316=$c_316+$dtt_raw_qty[$counter]->total_316; } @endphp 
                            <td scope="col" width="3%"> @php if((int)$dtt_raw[$counter]->total_316<=0 && (int)$dtt_raw_disc[$counter]->total_316>0){ echo 'Free'; }else{ echo number_format($dtt_raw[$counter]->total_316,0,',','.'); } @endphp </td>
                          @endif
                          @if((int)$header->total_309>0)
                            @php if((int)$dtt_raw[$counter]->total_309>0 || (int)$dtt_raw_disc[$counter]->total_309>0){ $c_309=$c_309+$dtt_raw_qty[$counter]->total_309; } @endphp 
                            <td scope="col" width="3%"> @php if((int)$dtt_raw[$counter]->total_309<=0 && (int)$dtt_raw_disc[$counter]->total_309>0){ echo 'Free'; }else{ echo number_format($dtt_raw[$counter]->total_309,0,',','.'); } @endphp </td>
                          @endif
                          @if((int)$header->total_318>0)
                            @php if((int)$dtt_raw[$counter]->total_318>0 || (int)$dtt_raw_disc[$counter]->total_318>0){ $c_318=$c_318+$dtt_raw_qty[$counter]->total_318; } @endphp 
                            <td scope="col" width="3%"> @php if((int)$dtt_raw[$counter]->total_318<=0 && (int)$dtt_raw_disc[$counter]->total_318>0){ echo 'Free'; }else{ echo number_format($dtt_raw[$counter]->total_318,0,',','.'); } @endphp </td>
                          @endif
                          @if((int)$header->total_319>0)
                            @php if((int)$dtt_raw[$counter]->total_319>0 || (int)$dtt_raw_disc[$counter]->total_319>0){ $c_319=$c_319+$dtt_raw_qty[$counter]->total_319; } @endphp 
                            <td scope="col" width="3%"> @php if((int)$dtt_raw[$counter]->total_319<=0 && (int)$dtt_raw_disc[$counter]->total_319>0){ echo 'Free'; }else{ echo number_format($dtt_raw[$counter]->total_319,0,',','.'); } @endphp </td>
                          @endif
                          @if((int)$header->total_467>0)
                            @php if((int)$dtt_raw[$counter]->total_467>0 || (int)$dtt_raw_disc[$counter]->total_467>0){ $c_467=$c_467+$dtt_raw_qty[$counter]->total_467; } @endphp 
                            <td scope="col" width="3%"> @php if((int)$dtt_raw[$counter]->total_467<=0 && (int)$dtt_raw_disc[$counter]->total_467>0){ echo 'Free'; }else{ echo number_format($dtt_raw[$counter]->total_467,0,',','.'); } @endphp </td>
                          @endif
                          @if((int)$header->total_488>0)
                            @php if((int)$dtt_raw[$counter]->total_488>0 || (int)$dtt_raw_disc[$counter]->total_488>0){ $c_488=$c_488+$dtt_raw_qty[$counter]->total_488; } @endphp 
                            <td scope="col" width="3%"> @php if((int)$dtt_raw[$counter]->total_488<=0 && (int)$dtt_raw_disc[$counter]->total_488>0){ echo 'Free'; }else{ echo number_format($dtt_raw[$counter]->total_488,0,',','.'); } @endphp </td>
                          @endif
                          @if((int)$header->total_494>0)
                            @php if((int)$dtt_raw[$counter]->total_494>0 || (int)$dtt_raw_disc[$counter]->total_494>0){ $c_494=$c_494+$dtt_raw_qty[$counter]->total_494; } @endphp 
                            <td scope="col" width="3%"> @php if((int)$dtt_raw[$counter]->total_494<=0 && (int)$dtt_raw_disc[$counter]->total_494>0){ echo 'Free'; }else{ echo number_format($dtt_raw[$counter]->total_494,0,',','.'); } @endphp </td>
                          @endif
                          @if((int)$header->total_329>0)
                            @php if((int)$dtt_raw[$counter]->total_329>0 || (int)$dtt_raw_disc[$counter]->total_329>0){ $c_329=$c_329+$dtt_raw_qty[$counter]->total_329; } @endphp 
