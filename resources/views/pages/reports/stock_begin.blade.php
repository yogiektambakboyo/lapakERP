...
@section('title', 'Laporan - Stock Begin')

@section('content')
    <div class="bg-light p-4 rounded">
        <h1>Laporan - Stock Awal</h1>
        ...
        <table class="table table-striped" id="example">
            ...
            <tr>
                ...
                <th scope="col">Tgl Saldo Awal</th>     
            ...
            <tbody>
                ...
                @foreach($report_data as $rdata)
                    <tr>
                        ...
                        <td>{{ $rdata->period_no }}</td>
                        <td>{{ $rdata->start_cal }}</td>
                        <td>{{ number_format($rdata->qty_stock,0,',','.') }}</td>
                        <td><a href="{{ route('reports.stock_begin.edit', [$rdata->start_cal,$rdata->branch_id ,$rdata->product_id]) }}" class="btn btn-info btn-sm {{ $act_permission->allow_edit==1?'':'' }} ">@lang('general.lbl_edit')</a></td>
                    </tr>
                @endforeach
            </tbody>
        </table>
        ...
        <div class="modal fade" id="modal-filter2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('reports.stock.search') }}" method="GET">   
                        @csrf 
                        <div class="col-md-10">
