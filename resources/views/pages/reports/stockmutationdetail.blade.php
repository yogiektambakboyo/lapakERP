...
@section('title', 'Laporan - Mutasi Stok Detail')
                    ...
                    foreach($report_data as $rdata){
                        ...
                        if($l_branch <> $rdata->branch_name || $l_product <> $rdata->product_name){
                            ...
                            <tr>
                                ...
                                <td data-order="'.($rdata->dated).'">'.($rdata->dated_display=="00-00-0000"?"00 - Saldo Awal - 00":$rdata->dated_display).'</td>
                            ...
                            <tr>
                                <th scope="row">'.$rdata->branch_name.'</th>
                                <td  data-order="'.($rdata->dated).'">'.$rdata->dated_display.'</td>
                                <td>'.$rdata->product_name.'</td>
                                <td>'.number_format($rdata->qty_in,0,',','.').'</td>
                                <td>'.number_format($rdata->qty_out,0,',','.').'</td>
                                <td>'.number_format($qty_begin,0,',','.').'</td>
        ...
        <div class="modal fade" id="modal-filter2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('reports.stockmutationdetail.search') }}" method="GET">   
                        @csrf 
                        <div class="col-md-10">
