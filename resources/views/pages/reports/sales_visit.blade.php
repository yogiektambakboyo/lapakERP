...
@section('title', 'Reports - Sales Visit')

@section('content')
    <div class="bg-light p-4 rounded">
        <h1>@lang('general.lbl_report') - @lang('general.lbl_sales_visit')</h1>
        ...
        <table class="table table-striped" id="example">
            <thead>
                <tr>
                    ...
                    <th scope="col" width="5%">@lang('general.lbl_customer')</th>
                    <th scope="col" width="15%">@lang('general.lbl_time_start')</th>
                    <th scope="col" width="15%">@lang('general.lbl_time_end')</th>
                    <th scope="col" width="15%">@lang('general.lbl_geolocation')</th>
                    <th scope="col" width="15%">@lang('general.lbl_georeverse')</th>
                    <th scope="col" width="5%">@lang('general.lbl_ischeckout')</th>   
        ...
        <div class="modal fade" id="modal-filter2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('reports.sales_visit.search') }}" method="GET">   
                        @csrf 
                        <div class="col-md-10">
