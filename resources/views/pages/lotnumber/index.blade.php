    ...
    <div class="bg-light p-4 rounded">
        ...
        <table class="table table-striped" id="table_view">
            ...
            <tr>
                ...
                <th scope="col" width="12%">@lang('general.lbl_qty_available')</th>
                <th scope="col" width="12%">@lang('general.lbl_qty_on_hand')</th>
                <th scope="col" width="12%">@lang('general.lbl_qty_allocated')</th>
            ...
            <tbody>
                ...
                @foreach($orders as $order)
                    <tr>
                        <td>{{ $order->doc_no }}</td>
                        <td>{{ $order->remark }}</td>
                        <td>{{ number_format($order->qty_available,0,',','.') }}</td>
                        <td>{{ number_format($order->qty_onhand,0,',','.') }}</td>
                        <td>{{ number_format($order->qty_allocated,0,',','.') }}</td>
