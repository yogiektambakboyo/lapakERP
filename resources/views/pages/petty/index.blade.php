    ...
    <div class="bg-light p-4 rounded">
        ...
        <div class="lead row mb-3">
            <div class="col-md-10">
                ...
                <div class="col-md-10"> 	
                    <form action="{{ route('petty.search') }}" method="GET" class="row row-cols-lg-auto g-3 align-items-center">
            ...
            <div class="col-md-2">
                <a href="{{ route('petty.create') }}" class="btn btn-primary float-right {{ $act_permission->allow_create==1?'':'d-none' }}"><span class="fa fa-plus-circle"></span>  @lang('general.btn_create')</a>
            </div>
        </div>
            ...
            <tbody>
                ...
                @foreach($invoices as $order)
                    <tr>
                        ...
                        <td><a href="{{ route('petty.show', $order->id) }}" class="btn btn-warning btn-sm  {{ $act_permission->allow_show==1?'':'d-none' }}">@lang('general.lbl_show')</a></td>
                        <td><a href="{{ route('petty.edit', $order->id) }}" class="btn btn-info btn-sm  {{ $act_permission->allow_edit==1?'':'d-none' }} ">@lang('general.lbl_edit')</a></td>
        ...
        <div class="modal fade" id="modal-filter" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('petty.search') }}" method="GET">   
                        @csrf 
                        <div class="col-md-10">
     ...
     //$('#app').removeClass('app app-sidebar-fixed app-header-fixed-minified').addClass('app app-sidebar-fixed app-header-fixed-minified app-sidebar-minified');
          ...
          function showConfirm(id,data){
            ...
            confirmButtonText: "@lang('general.lbl_sure_delete')"
                ...
                if (result.isConfirmed) {
                    var url = "{{ route('petty.destroy','XX') }}";
                    var lastvalurl = "XX";
                    console.log(url);
                                ...
                                if(resp.data.status=="success"){
                                    Swal.fire({
                                        ...
                                        confirmButtonText: "@lang('general.lbl_close') "
                                            ...
                                            window.location.href = "{{ route('petty.index') }}"; 
                                        })
                                }else{
                                    Swal.fire(
                                    {
        ...
        function showConfirmCheckout(id,data){
            ...
            confirmButtonText: "@lang('general.lbl_sure_checkout')"
                ...
                if (result.isConfirmed) {
                    var url = "{{ route('petty.checkout','XX') }}";
                    var lastvalurl = "XX";
                    console.log(url);
                    url = url.replace(lastvalurl, id)
