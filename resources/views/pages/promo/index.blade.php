            ...
            <tbody>
                ...
                @foreach($orders as $order)
                    <tr>
                        ...
                        <td><a href="{{ route('promo.show', $order->id) }}" class="btn btn-warning btn-sm  {{ $act_permission->allow_show==1?'':'d-none' }}">@lang('general.lbl_show')</a></td>
                        <td><a href="{{ route('promo.edit', $order->id) }}" class="btn btn-info btn-sm  {{ $act_permission->allow_edit==1?'':'d-none' }}">@lang('general.lbl_edit')</a></td>
                    </tr>
                @endforeach
            </tbody>
        </table>
