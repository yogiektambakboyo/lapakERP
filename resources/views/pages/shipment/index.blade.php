    ...
    <div class="bg-light p-4 rounded">
        ...
        <div class="lead row mb-3">
            <div class="col-md-10">
                ...
                <div class="col-md-10"> 	
                    <form action="{{ route('shipment.search') }}" method="GET" class="row row-cols-lg-auto g-3 align-items-center">
            ...
            <div class="col-md-2">
                <a href="{{ route('shipment.create') }}" class="btn btn-primary float-right {{ $act_permission->allow_create==1?'':'d-none' }}"><span class="fa fa-plus-circle"></span>  @lang('general.btn_create')</a>
            </div>
        </div>
            ...
            <tbody>
                ...
                @foreach($invoices as $order)
                    <tr>
                        ...
                        <td>{{ $order->remark }}</td>
                        <td><a href="{{ route('shipment.show', $order->id) }}" class="btn btn-warning btn-sm  {{ $act_permission->allow_show==1?'':'d-none' }}">@lang('general.lbl_show')</a></td>
                        <td><a href="{{ route('shipment.edit', $order->id) }}" class="btn btn-info btn-sm  {{ $act_permission->allow_edit==1?'':'d-none' }}">@lang('general.lbl_edit')</a></td>
                    </tr>
                @endforeach
            </tbody>
        </table>
