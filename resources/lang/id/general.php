...
return [
    ...
    "lbl_save" => "Simpan",
    "lbl_seller" => "Seller",
    "lbl_credit_limit" => "Batas Kredit",
    "lbl_product" => "Produk",
    "lbl_activeselect" => "Pilih Status",
    "lbl_cancel" => "Batal",
    "lbl_ref_by" => "Dijual Oleh",
    "lbl_shift_branch" => "Shift Outlet",
    "lbl_shift_branch_new" => "Buat Shift Outlet",
    "lbl_close" => "Tutup",
    "lbl_price" => "Harga",
