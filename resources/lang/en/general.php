...
return [
    ...
    "tipe" => "Type",
    "lbl_return_sell" => "Return",
    "lbl_return_new" => "New Return",
    ...
    "lbl_categoryselect" => "Pilih Category",
    "lbl_brand" => "Merek",
    ...
    "lbl_categoryedit" => "Ubah Category",
    "lbl_photo" => "Foto",
    ...
    "lbl_branch" => "Outlet",
    "lbl_branch_new" => "New Outlet",
    "lbl_city" => "City",
    "lbl_welcome_to" => "Welcome to ",
    "lbl_citizenid" => "No KTP",
    "lbl_branchselect" => "Pilih Outlet",
    "lbl_allbranch" => "Semua Outlet",
    ...
    "lbl_tax" => "Tax",
    "lbl_print" => "Print",
    "lbl_product_desc" => "Product Description",
    ...
    "lbl_add_brand_new" => "Add New Brand",
    "lbl_add_stock_new" => "Tambah Stok Produk Baru",
    "lbl_add_uom_new" => "Add New UOM",
    "lbl_add_category_new" => "Add New Category",
    "lbl_add_distribution_new" => "Add New Distribution",
    "lbl_add_point_new" => "Tambah Poin Baru",
    "lbl_customer_new" => "Add New Customer",
    "lbl_seller_new" => "Add New Seller",

    "lbl_sure" => "Are you sure?",
    "lbl_sure_title" => "You will delete data ",
    "lbl_sure_delete" => "Yes, Delete!",
    "lbl_msg_delete" => "Deleted!",
    "lbl_msg_delete_title" => "Data anda telah berhasil dihapus",
    "lbl_msg_failed" => "Something went wrong - ",
    "lbl_ingredient" => "Bahan Baku",
    "lbl_handphone" => "Handphone",
    "lbl_contactperson" =>"Contact",
    ...
    "lbl_product_stock" => "Stock Product",
    ...
    "lbl_product_distribution" => "Distribution",
    "lbl_point" => "Poin",
    ...
    "lbl_seller" => "Seller",
    "lbl_sales" => "Seller",
    "lbl_calcpromo" => "Calc Discount",
    "lbl_dated_start" => "Tgl Mulai",
    "lbl_dated_end" => "Tgl Akhir",
