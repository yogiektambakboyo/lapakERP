...
{   
    ...
    Route::group(['middleware' => ['auth', 'permission']], function() {
        ...
        Route::group(['prefix' => 'reports'], function() {
            ...
            Route::get('/customer_reg', 'ReportCustomerRegDetailController@index')->name('reports.customer_reg.index');
            Route::get('/search_customer_reg_detail', 'ReportCustomerRegDetailController@search')->name('reports.customer_reg.search');
