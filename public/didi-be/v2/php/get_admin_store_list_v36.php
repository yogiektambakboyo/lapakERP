...
//if($method == 'SFA_Borwita_Android'){
	try {
	   ...
	   if (!$dbh) {
			...
			$query = " select * from (select n.city,l.storecode,n.name,n.address,'2017-01-01 00:00' as lastconnect,n.isparent as status from x_admin_user u
						...
						union 
						select 'SYSTEM' as city,'0' as storecode,'0-- SYSTEM --0' as name,'SYSTEM' as address,'2017-01-01 00:00' as lastconnect,'1' as status from x_user where usercode=1
						) a order by name  ";
