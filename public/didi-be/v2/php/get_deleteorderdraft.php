...
//if($method == 'SFA_Borwita_Android'){
	...
	try {
	   ...
	   if (!$dbh) {
			...
			$query = " delete from x_orderdraft x where x.usercode=:usercode and (x.storecode=:storecode or x.storecode=0 or x.storecode=1) and x.skucode=:skucode and isinvoice='0' ";
