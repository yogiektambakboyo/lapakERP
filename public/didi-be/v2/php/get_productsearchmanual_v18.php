...
//if($method == 'SFA_Borwita_Android'){
	...
	try {
	   ...
	   if (!$dbh) {
			...
			$query = " select s.skucode as kode,s.printdesc as nama,COALESCE(s.barcode,'XXXXXDD') as barcode,coalesce(p.price,0) as price 
			 ...
			 where upper(s.description) like '%'||:keyword1||'%' or s.barcode like '%'||:keyword4||'%' or upper(c.categoryname) like '%'||:keyword2||'%' or upper(n.brandname) like '%'||:keyword3||'%' ";
