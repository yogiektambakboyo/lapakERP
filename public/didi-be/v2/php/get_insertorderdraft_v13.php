	...
	try {
	   ...
	   if (!$dbh) {
			...
			if(intval($c)>0){
				...
				//$query = " INSERT INTO x_orderdraft(usercode, storecode, skucode, qty, price, sequence, createdate,isinvoice) VALUES (:usercode, :storecode, :skucode, :qty, :price, :sequence, now(),'0') ";
