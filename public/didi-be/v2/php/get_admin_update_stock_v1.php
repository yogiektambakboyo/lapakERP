...
//if($method == 'SFA_Borwita_Android'){
	...
	try {
	   ...
	   if (!$dbh) {
			...
			$query = " select update_stock_v1(:storecode,:skucode,:price,:qty,:active,:isempty,:pricem1,:pricem2,:barcode,:searchkey) as status ";
			...
			$stmt->bindParam(':barcode', $barcode, PDO::PARAM_STR,50);	
			$stmt->bindParam(':searchkey', $keyword, PDO::PARAM_STR, 200);	
			$stmt->execute();			
