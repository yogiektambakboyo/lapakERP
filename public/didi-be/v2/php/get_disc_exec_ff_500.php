	...
	try {
	   ...
	   if (!$dbh) {
			...
			$query = " INSERT INTO public.x_orderdraft(
						...
						select x.usercode, b.storecode, s.skucode, i.min_qty as qty,
						...
						join x_disc_detail_item i on i.skucode=s.skucode and i.disc_id='FF-500x'
						join x_user x on x.usercode=:usercode  and x.city='KUTA JAYA'
						join x_user xq on xq.usercode=:usercode3 and xq.city='KUTA JAYA' and xq.isposadmin='0'
			...
			$stmt->bindParam(':usercode3', $user_mirror, PDO::PARAM_STR,50);	
