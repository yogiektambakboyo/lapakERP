...
//if($method == 'SFA_Borwita_Android'){
	...
	try {
	   ...
	   if (!$dbh) {
			...
			$query = " select cost from x_deliverycost where storecode=(select storecode from x_orderdraft where usercode=:usercode2 and isinvoice='0' LIMIT 1) and :usercode like usercode  ";
